...
struct SmtDimInfo ea8061_dimming_info_D[MAX_BR_INFO + 1] = {				// add hbm array
	...
	{.br = 111, .refBr = 168, .cGma = gma2p00, .rTbl = D_rtbl111nit, .cTbl = D_ctbl111nit, .aid = D_aid3662, .elvAcl = elv7, .elv = elv7},
	{.br = 119, .refBr = 183, .cGma = gma2p00, .rTbl = D_rtbl119nit, .cTbl = D_ctbl119nit, .aid = D_aid3662, .elvAcl = elv8, .elv = elv8},
	{.br = 126, .refBr = 191, .cGma = gma2p00, .rTbl = D_rtbl126nit, .cTbl = D_ctbl126nit, .aid = D_aid3662, .elvAcl = elv8, .elv = elv8},
	{.br = 134, .refBr = 201, .cGma = gma2p00, .rTbl = D_rtbl134nit, .cTbl = D_ctbl134nit, .aid = D_aid3662, .elvAcl = elv9, .elv = elv9},

	{.br = 143, .refBr = 214, .cGma = gma2p00, .rTbl = D_rtbl143nit, .cTbl = D_ctbl143nit, .aid = D_aid3662, .elvAcl = elv10, .elv = elv10},
	{.br = 152, .refBr = 226, .cGma = gma2p00, .rTbl = D_rtbl152nit, .cTbl = D_ctbl152nit, .aid = D_aid3662, .elvAcl = elv11, .elv = elv11},
	{.br = 162, .refBr = 239, .cGma = gma2p00, .rTbl = D_rtbl162nit, .cTbl = D_ctbl162nit, .aid = D_aid3662, .elvAcl = elv12, .elv = elv12},

	{.br = 172, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl172nit, .cTbl = D_ctbl172nit, .aid = D_aid3662, .elvAcl = elv12, .elv = elv12},
	{.br = 183, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl183nit, .cTbl = D_ctbl183nit, .aid = D_aid3200, .elvAcl = elv12, .elv = elv12},
	{.br = 195, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl195nit, .cTbl = D_ctbl195nit, .aid = D_aid2708, .elvAcl = elv13, .elv = elv13},
	{.br = 207, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl207nit, .cTbl = D_ctbl207nit, .aid = D_aid2185, .elvAcl = elv14, .elv = elv14},
	{.br = 220, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl220nit, .cTbl = D_ctbl220nit, .aid = D_aid1654, .elvAcl = elv14, .elv = elv14},
	{.br = 234, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl234nit, .cTbl = D_ctbl234nit, .aid = D_aid1038, .elvAcl = elv14, .elv = elv14},

	{.br = 249, .refBr = 253, .cGma = gma2p00, .rTbl = D_rtbl249nit, .cTbl = D_ctbl249nit, .aid = D_aid0369, .elvAcl = elv15, .elv = elv15},		// 249 ~ 360nit acl off
